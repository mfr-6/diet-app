...
def test_read_products_when_products_present(test_client) -> None:
    ...
    with patch("app.api.products.routes.db_read_products", return_value=test_products) as mock_db_read_products:
...
def test_read_product_when_product_present(test_client) -> None:
    ...
    with patch("app.api.products.routes.db_read_product", return_value=test_product) as mock_db_read_product:
...
def test_read_product_when_product_missing(test_client) -> None:
    with patch("app.api.products.routes.db_read_product", side_effect=ProductNotFoundError("Product not found")) as mock_db_read_product:
...
def test_create_product(test_client) -> None:
    ...
    with patch("app.api.products.routes.db_create_product", return_value=test_product) as mock_db_create_product:
...
def test_delete_product_when_product_present(test_client) -> None:
    with patch("app.api.products.routes.db_delete_product", return_value=None) as mock_db_delete_product:
...
def test_update_product_when_target_product_present(test_client) -> None:
    ...
    with patch("app.api.products.routes.db_update_product", return_value=updated_product) as mock_db_update_product:
...
def test_update_product_when_target_product_missing(test_client) -> None:
    ...
    with patch("app.api.products.routes.db_update_product", side_effect=ProductNotFoundError("Product not found")) as mock_db_update_product:
        response = test_client.put(f"/api/v1/products/{product_id}", json=product_body)
...
def test_delete_product_when_product_missing(test_client) -> None:
    with patch("app.api.products.routes.db_delete_product", side_effect=ProductNotFoundError("Product not found")) as mock_db_delete_product:
